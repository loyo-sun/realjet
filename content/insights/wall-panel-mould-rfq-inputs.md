---
title: "Wall Panel Mould RFQ for a Precast Production Line"
description: "Prepare a wall panel mould RFQ for a precast concrete production line, covering geometry, casting direction, surface finish, embedded items and cycle time."
date: 2026-08-22
updated: 2026-08-22
slug: "wall-panel-mould-rfq-inputs"
image: "/images/insights/wall-panel-mould-rfq-inputs.webp"
imageAlt: "Upright blue steel wall panel mould standing in a fabrication workshop ready for delivery to a precast building component factory"
...
[PCI MNL-117](https://www.pci.org/PCI/Standards/Resources/Manuals/MNL-117_-_Architectural_Precast_Concrete) is the architectural precast concrete manual most North American projects use for finish, tolerance and repair guidance. [ACI ITG-7](https://www.concrete.org/store/productdetail.aspx?ItemID=ITG-7) covers architectural precast tolerance, and European projects often reference [EN 13369](https://www.en-standard.eu/csn-en-13369-common-rules-for-precast-concrete-products/) for common rules on precast products. The buyer should say which standard applies to the panel finish and the tolerance class, and whether the mould is expected to deliver a particular class on the architectural face.
...
The buyer should state which level of scope is being requested, and the supplier should list the assumptions and exclusions that come with that level. The [wall panel mould product reference](https://realjetech.com/marketing/precast-concrete-molds/wall-panel-moulds/) shows the kind of configuration directions a project can take, while final dimensions, interfaces and delivery scope are confirmed through the buyer's project documents. A clear boundary in the RFQ gives the buyer comparable bids and gives the supplier a stable basis to design against.
