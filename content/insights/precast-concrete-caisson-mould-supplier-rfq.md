...
Marine exposure also makes concrete specification and construction control project-critical. The UK Environment Agency's [guidance on best practice for marine concrete](https://www.gov.uk/flood-and-coastal-erosion-risk-management-research-reports/new-guidance-on-best-practice-for-using-marine-concrete) focuses on achieving durable concrete in coastal and marine structures. A mould supplier does not set that durability design, but the proposed formwork, access and casting arrangement must support the approved concrete and inspection plan.
