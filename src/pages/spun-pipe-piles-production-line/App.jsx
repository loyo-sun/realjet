        ...
        <section id="advantages" className="scroll-mt-20 bg-white py-20">
          <div className="site-container">
            ...
            <div className="grid grid-cols-[1.05fr_.95fr] items-center gap-10 text-brand-navy max-[900px]:grid-cols-1 max-[900px]:gap-6">
              ...
              <div className="flex flex-col justify-center"><span className="text-xs font-[900] tracking-[.16em] text-brand-blue uppercase">01 · Production line planning</span><h3 className="mt-3 text-3xl font-[950] tracking-[-.03em]">A layout built around your plant</h3><p className="mt-4 text-sm leading-7 text-muted">We plan around your site and target cycle time to build the right production line at the lowest practical cost.</p><div className="mt-6 grid grid-cols-2 gap-3 max-[520px]:grid-cols-1">{["Cycle-time model", "Mould circulation", "Crane & logistics", "Plant constraints"].map((item) => <div key={item} className="flex items-center gap-2 py-2 text-sm font-bold"><Check size={16} className="text-brand-cyan" />{item}</div>)}</div></div>
            </div>
...
function LegacyLocalizedPage({ locale = "en" }) {
  ...
  const messagingNumber = "+86 193 1009 0600";
