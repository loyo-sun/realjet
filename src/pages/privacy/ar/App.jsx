        ...
        <div className="site-container grid grid-cols-[250px_minmax(0,1fr)] gap-12 py-16 max-[1000px]:grid-cols-1 max-[720px]:gap-8 max-[720px]:py-10">
          ...
          <article className="min-w-0 max-w-[830px]">
            ...
            <PolicySection id="cookies" title="10. ملفات تعريف الارتباط والتقنيات المشابهة">
              ...
              <p>تُعد Google Analytics 4، وقياس الإحالات في Google Ads عند تهيئته، خدمات اختيارية من Google. يُفعّل «قبول الكل» أغراض التحليلات والإعلانات معًا. ويتيح لك مفتاحا التحكم أدناه تفعيل التحليلات والإعلانات أو تعطيلهما بشكل مستقل. ويعني إغلاق الإشعار الأولي دون القبول رفض الغرضين الاختياريين.</p>
              <p>يمكنك تغيير اختيارك أو سحبه في أي وقت من خلال تفضيلات ملفات الارتباط. عند السماح، قد تستخدم علامات Google ملفات ارتباط وتعالج معلومات ذات أسماء مستعارة عن الجهاز والصفحات والتفاعلات وإسناد الإعلانات. لا نرسل محتوى نموذج الاستفسار إلى Google Analytics أو Google Ads.</p>
              <ul>
                <li>الغرض: قياس استخدام الصفحات وفعالية مسار الاستفسار، وإحالات الإعلانات عند تهيئتها؛</li>
                <li>المزود: Google LLC ‏(Google Analytics 4 وGoogle Ads عند تهيئته)؛</li>
              ...
              <AnalyticsPreferenceSwitch locale="ar" label="إدارة تفضيلات ملفات الارتباط" />
            </PolicySection>
