        ...
        <div className="site-container grid grid-cols-[250px_minmax(0,1fr)] gap-12 py-16 max-[1000px]:grid-cols-1 max-[720px]:gap-8 max-[720px]:py-10">
          ...
          <article className="min-w-0 max-w-[830px]">
            ...
            <PolicySection id="cookies" title="10. ملفات تعريف الارتباط والتقنيات المشابهة">
              ...
              <p>تُعد Google Analytics 4، وقياس الإحالات في Google Ads عند تهيئته، خدمات اختيارية من Google. يُفعّل «قبول الكل» تخزين التحليلات والإعلانات وبيانات المستخدم الإعلانية وتخصيص الإعلانات؛ ويُفعّل «التحليلات فقط» تخزين التحليلات فقط؛ أما «رفض الكل» فيعطّل جميع الأغراض الاختيارية.</p>
              ...
              <AnalyticsPreferenceSwitch label="إدارة تفضيلات ملفات الارتباط" />
            </PolicySection>
