    ...
    <div dir="rtl">
      <header className="sticky top-0 z-30 h-[70px] border-b border-white/10 bg-brand-navy/97 text-white backdrop-blur-xl max-[720px]:h-[62px]">
        <div className="site-container flex h-full items-center justify-between gap-5">
          <a href="../../precast-beam-factory/ar/" aria-label="خطوط Realjet لإنتاج العناصر الخرسانية مسبقة الصب">
        ...
        <div className="site-container grid grid-cols-[250px_minmax(0,1fr)] gap-12 py-16 max-[1000px]:grid-cols-1 max-[720px]:gap-8 max-[720px]:py-10">
          ...
          <article className="min-w-0 max-w-[830px]">
            ...
            <PolicySection id="information-we-collect" title="2. المعلومات التي نجمعها">
              ...
              <p>لا يستخدم الموقع حاليًا وحدات بكسل إعلانية أو أدوات تتبع تحليلية. وإذا أضفنا مستقبلًا تحليلات أو إعلانات أو ملفات تعريف ارتباط غير ضرورية، فسنحدّث هذه السياسة ونوفر قبل تفعيلها أي آلية موافقة يقتضيها القانون المنطبق.</p>
            </PolicySection>
            ...
            <PolicySection id="cookies" title="10. ملفات تعريف الارتباط والتقنيات المشابهة">
              ...
              <p>إذا أضفنا لاحقًا تحليلات أو إعلانات أو تقنيات أخرى غير ضرورية، فسوف:</p>
              <ul>
                <li>نحدّث سياسة الخصوصية هذه؛</li>
                <li>نحدد مقدمي الخدمات المعنيين وأغراض الاستخدام؛</li>
                <li>نوضح ترتيبات الاحتفاظ والنقل المنطبقة؛</li>
                <li>نوفر أداة للتحكم في ملفات تعريف الارتباط أو الموافقة عندما يقتضي القانون ذلك.</li>
              </ul>
            </PolicySection>
