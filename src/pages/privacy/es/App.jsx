    ...
    <>
      <header className="sticky top-0 z-30 h-[70px] border-b border-white/10 bg-brand-navy/97 text-white backdrop-blur-xl max-[720px]:h-[62px]">
        <div className="site-container flex h-full items-center justify-between gap-5">
          <a href="../../precast-beam-factory/es/" aria-label="Líneas de producción de prefabricados Realjet">
          ...
          <a href="../../precast-beam-factory/es/" className="inline-flex min-h-10 items-center gap-2 rounded-lg border border-white/15 px-3 text-[12px] font-[750] text-white/80 transition hover:border-white/30 hover:text-white">
            <ArrowLeft size={15} aria-hidden="true" />
            <span className="max-[430px]:hidden">Volver a las líneas de producción</span>
            <span className="hidden max-[430px]:inline">Volver</span>
          </a>
        </div>
      </header>
          ...
          <div className="site-container py-16 max-[720px]:py-12">
            <div className="flex max-w-[820px] items-start gap-5">
              ...
              <div>
                ...
                <p className="mt-5 text-[12px] font-[750] text-white/55">Fecha de entrada en vigor: 30 de julio de 2026</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <div className="site-container grid grid-cols-[250px_minmax(0,1fr)] gap-12 py-16 max-[1000px]:grid-cols-1 max-[720px]:gap-8 max-[720px]:py-10">
          ...
          <article className="min-w-0 max-w-[830px]">
            ...
            <PolicySection id="information-we-collect" title="2. Información que recopilamos">
              ...
              <p>Actualmente, el sitio web no utiliza píxeles publicitarios ni rastreadores analíticos. Si en el futuro incorporamos herramientas de analítica, publicidad o cookies no esenciales, actualizaremos esta Política de privacidad e implantaremos el mecanismo de consentimiento exigido por la legislación aplicable antes de activarlas.</p>
            </PolicySection>
            ...
            <PolicySection id="cookies" title="10. Cookies y tecnologías similares">
              <p>Actualmente, el sitio web no utiliza cookies publicitarias, píxeles publicitarios ni rastreadores analíticos.</p>
              ...
              <p>Si posteriormente incorporamos analítica, publicidad u otras tecnologías no esenciales:</p>
              <ul>
                <li>actualizaremos esta Política de privacidad;</li>
                <li>identificaremos los proveedores y las finalidades correspondientes;</li>
                <li>explicaremos los plazos de conservación y las transferencias aplicables;</li>
                <li>proporcionaremos un control de cookies o consentimiento cuando la ley lo exija.</li>
              </ul>
            </PolicySection>
