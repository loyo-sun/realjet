  ...
  return (
    <header className="sticky top-0 z-40 h-[70px] border-b border-white/10 bg-brand-navy/97 text-white backdrop-blur-xl max-[720px]:h-[62px]">
      <div className="site-container flex h-full items-center gap-6 max-[720px]:gap-2">
        ...
        <button onClick={() => onLead("Diseño personalizado gratis")} className="rounded-lg bg-[#d94824] px-3.5 py-2 text-xs font-[850] text-white shadow-[0_8px_22px_rgba(217,72,36,.28)] transition hover:bg-[#b93619] focus-visible:bg-[#b93619] max-[1100px]:ml-auto max-[720px]:hidden">Diseño personalizado gratis</button>
  ...
  return (
    <>
      <div id="site-shell">
        ...
        <FloatingContactActions canonicalUrl="https://realjetech.com/marketing/precast-beam-factory/es/" enquiryTitle="Diseño personalizado gratis" onEnquire={openLead} subject="una línea de producción de vigas prefabricadas" />
