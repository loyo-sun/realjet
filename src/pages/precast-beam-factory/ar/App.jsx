  ...
  return (
    <header className="sticky top-0 z-40 h-[70px] border-b border-white/10 bg-brand-navy/97 text-white backdrop-blur-xl max-[720px]:h-[62px]">
      <div className="site-container flex h-full items-center gap-6 max-[720px]:gap-2">
        <a href="/" aria-label="الصفحة الرئيسية لـ Realjet" className="shrink-0">
        ...
        <button onClick={() => onLead("احصل على تصميم خط مجاني")} className="rounded-lg bg-[#d94824] px-3.5 py-2 text-xs font-[850] text-white shadow-[0_8px_22px_rgba(217,72,36,.28)] transition hover:bg-[#b93619] focus-visible:bg-[#b93619] max-[1100px]:mr-auto max-[720px]:hidden">احصل على تصميم خط مجاني</button>
...
function LeadModal({ open, onClose, title }) {
  ...
  const handleSubmit = async (event) => {
    ...
    const body = createBeamFactoryEnquiryBody(form, { locale: "ar", title });
  ...
  return (
    <>
      <div id="site-shell" data-locale="ar" dir="rtl">
        ...
        <FloatingContactActions canonicalUrl="https://realjetech.com/marketing/precast-beam-factory/ar/" enquiryTitle="احصل على تصميم خط مجاني" onEnquire={openLead} subject="خط إنتاج الكمرات مسبقة الصب" />
