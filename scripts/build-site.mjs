...
for (const expectedPath of [
  ...
  "precast-concrete-molds/accropode-moulds/index.html",
  "precast-concrete-molds/tetrapod-moulds/index.html",
  "precast-concrete-molds/precast-concrete-caisson-moulds/index.html",
  "admin/index.html",
  "admin/config.yml",
  "admin/config.zh.yml",
  "sitemap.xml",
...
if (mouldProductCardCount !== 20) {
  throw new Error(`Precast moulds page must contain exactly 20 product cards; found ${mouldProductCardCount}.`);
}
...
if (landingProductActionCount !== 20) {
...
for (const requiredContent of [
  ...
  'meta name="robots" content="index, follow"',
  "Prestressed Spun Concrete Pile Production Line",
  'name="universal-enquiry"',
  'name="name"',
  'name="email"',
  'name="message"',
  ...
  if (!spunPipePilesPage.includes(requiredContent)) {
    throw new Error(`Prestressed spun concrete pile page validation failed: ${requiredContent}`);
  }
}
...
for (const requiredSitemapUrl of [
  ...
  "https://realjetech.com/precast-concrete-molds/accropode-moulds/",
